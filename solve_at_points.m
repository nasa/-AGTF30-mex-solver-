...
for input_num = 1:num_inputs
    ...
    if convergence_reached
        [A, B, C, D, linearization_failure_mode] = do_linearization(solver_independents_solution, X, Y, ...
            altitude, mach_number, N1c, VAFN_interpolant, VBV_interpolant, environmental_conditions, ...
